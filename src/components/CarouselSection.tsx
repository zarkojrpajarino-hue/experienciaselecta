    ...
    >
      <div className="flex flex-col w-full h-full" style={{ margin: 0, padding: 0 }}>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div 
            className="w-full max-w-5xl mx-auto h-[35vh] md:h-[40vh] relative cursor-pointer overflow-hidden rounded-3xl md:rounded-[2rem]"
          ...
          >
            {slides.map((slide, index) => (
              <img
                ...
                src={slide.image}
                alt={`Slide ${index + 1}`}
                className={`absolute inset-0 w-full h-full object-cover md:object-contain transition-opacity duration-700 ease-in-out rounded-3xl md:rounded-[2rem] ${
