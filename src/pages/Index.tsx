...
const Index = () => {
  ...
  const processSlides = [
    ...
    { image: nuevaSeccion03Img, title: "<span style='color: black;'>Compra o regala cestas que guían hacia una <span style='color: #FFD700; font-weight: bold;'>experiencia única</span> y <span style='color: #FFD700; font-weight: bold;'>personalizada</span>, para explorar <span style='color: #FFD700; font-weight: bold;'>emociones</span> que no conocías y hacer un <span style='color: #FFD700; font-weight: bold;'>regalo original</span> e <span style='color: #FFD700; font-weight: bold;'>inolvidable</span> de forma <span style='color: #FFD700; font-weight: bold;'>asequible</span>.</span>" },
