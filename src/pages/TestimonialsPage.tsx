    ...
    backgroundAttachment: 'fixed'
      ...
      <Dialog open={isImageOpen} onOpenChange={setIsImageOpen}>
        <DialogContent className="max-w-7xl bg-transparent border-0 p-2 shadow-none rounded-3xl overflow-hidden">
          ...
          <img src={testimonials[currentTestimonial].image} alt={`Experiencia ${testimonials[currentTestimonial].experience}`} className="w-full h-auto max-h-[80vh] object-contain rounded-2xl" />
        </DialogContent>
      </Dialog>
    </div>;
};
