...
serve(async (req) => {
  ...
  try {
    ...
    const { data: gift, error: giftError } = await supabase
      ...
      .insert({
        order_id: order.id,
        sender_name: 'Usuario Nova',
        sender_email: 'zarkojr.nova@gmail.com',
        recipient_name: 'Usuario Pajarino',
        recipient_email: 'zarkojrpajarino@gmail.com',
        basket_name: 'Trio ibérico',
        basket_category: 'Amigos',
        basket_image: 'https://dddfbmlvwswydkufphtq.supabase.co/storage/v1/object/public/baskets/trio-iberico-nuevo-clean.jpg',
        price: 4500,
        quantity: 1,
